...
function preload(){
  ...
  backgroundImg = loadImage("fondo de minecraft.jpg")
  sunAnimation = loadImage("sun.png");
  
  trex_running = loadAnimation("steve 1.png","steve 2.png","steve 3.png");
  trex_collided = loadAnimation("steve llorando.png");
  
  groundImage = loadImage("ground.png");
  
  cloudImage = loadImage("cloud.png");
  
  obstacle1 = loadImage("mi bloque.PNG");
  obstacle2 = loadImage("zombie mega 1.png");
  obstacle3 = loadImage("creeper 1.png");
  obstacle4 = loadImage("creeper 1.png");
